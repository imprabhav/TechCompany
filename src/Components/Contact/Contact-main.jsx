...
const Contact = () => {
  ...
  return (
    <div className="py-20 bg-gray-900 px-4 md:px-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-gray-800 p-8 rounded-lg shadow-lg text-white">
          ...
          <div className="space-y-4">
            <div className="bg-gray-700 text-gray-300 p-4 rounded-md shadow-md">
              <strong className="block text-xl text-blue-400 mb-1">
                Address:
              </strong>
              <p>
                2 Wolsey Island Way
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full p-3 bg-gray-700 text-gray-200 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                required
              />
            </div>
            <div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className="w-full p-3 h-32 bg-gray-700 text-gray-200 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                required
              ></textarea>
            </div>
